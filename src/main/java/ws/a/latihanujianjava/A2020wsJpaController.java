...
import ws.a.latihanujianjava.exceptions.PreexistingEntityException;
...
public class A2020wsJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_latihanujianjava_jar_0.0.1-SNAPSHOTPU");
